...
# Problem 38: Total Control
## **2025-11-26**

C++ lets you control lots of things.
...
```C++
C *p = new(std::cout) C; // Running C's allocator
...
```C++
try {
    C *p = new(std::cout) C{true};  // throws - specialized delete is called automatically
...
So you need _both_ a standard and a specialized `operator delete`.
